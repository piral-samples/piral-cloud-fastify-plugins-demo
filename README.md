...
> Sample project to illustrate a plugin discovery with a Fastify server.

:zap: Use the Piral Feed Service for plugin discovery - making your Fastify server extensible.

Feel free to play around with the code using StackBlitz.

[![Open in StackBlitz](https://developer.stackblitz.com/img/open_in_stackblitz.svg)](https://stackblitz.com/github/piral-samples/piral-cloud-fastify-plugins-demo)
